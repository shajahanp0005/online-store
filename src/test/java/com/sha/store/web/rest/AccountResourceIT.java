package com.sha.store.web.rest;

import com.sha.store.StoreApp;
import com.sha.store.config.Constants;
import com.sha.store.domain.User;
import com.sha.store.repository.AuthorityRepository;
import com.sha.store.repository.UserRepository;
import com.sha.store.security.AuthoritiesConstants;
import com.sha.store.service.UserService;
import com.sha.store.service.dto.PasswordChangeDTO;
import com.sha.store.service.dto.UserDTO;
import com.sha.store.web.rest.vm.KeyAndPasswordVM;
import com.sha.store.web.rest.vm.ManagedUserVM;
...
import static com.sha.store.web.rest.AccountResourceIT.TEST_USER_LOGIN;

...
import com.sha.store.config.audit.AuditEventConverter;
import com.sha.store.domain.PersistentAuditEvent;
import com.sha.store.repository.PersistenceAuditEventRepository;
import com.sha.store.security.AuthoritiesConstants;

import com.sha.store.service.AuditEventService;
